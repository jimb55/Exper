 ...
 * Class Mail
 *
 * 来源: https://www.cnblogs.com/woider/p/6980456.html
 */
class Mail
{
    ...
    private static $USERNAME = '1910381520@qq.com'; // 授权登录的账号
    private static $PASSWORD = 'zgddovpczoihfbea'; // 授权登录的密码
    private static $NICKNAME = 'jimb55'; // 发件人的昵称
